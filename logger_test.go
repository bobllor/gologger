...
func TestLogContent(t *testing.T) {
	log := NewLogger(log.New(bytes.NewBuffer([]byte{}), "", logFlag), Lsilent)
...
func TestLogContentString(t *testing.T) {
	log := NewLogger(log.New(bytes.NewBuffer([]byte{}), "", logFlag), Ldebug)
...
func TestLogToTerminalStderr(t *testing.T) {
	log := NewLogger(log.New(bytes.NewBuffer([]byte{}), "", logFlag), Lwarn)
